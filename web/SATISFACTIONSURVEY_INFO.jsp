...
<head>
    ...
    <script type="text/javascript" src="IC_js/SATISFACTIONSURVEY_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿满意度调查管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">调查人员</th>
                        <th class="table-title">调查部门</th>
                        <th class="table-title">调查方式</th>
                        <th class="table-title">调查时间</th>
                        <th class="table-title">调查内容</th>
                        <th class="table-title">调查总体满意度</th>
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("SATISFACTIONSURVEY_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("surveryPerson")!=null ?entity.getAttributeValue("surveryPerson"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("surveryDept")!=null ?entity.getAttributeValue("surveryDept"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("surveryMethod")!=null ?entity.getAttributeValue("surveryMethod"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("surveryDateTime")!=null ?entity.getAttributeValue("surveryDateTime"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("surveryContent")!=null ?entity.getAttributeValue("surveryContent"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("overallSatisfaction")!=null ?entity.getAttributeValue("overallSatisfaction"):""%>
                        </td>
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="SATISFACTIONSURVEY_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    ...
                    <td>调查人员</td>
                    <td><input id="surveryPerson"></td>
                </tr>                <tr>
                    <td>调查部门</td>
                    <td><input id="surveryDept"></td>
                    <td>调查方式</td>
                    <td><input id="surveryMethod"></td>
                </tr>                <tr>
                    <td>调查时间</td>
                    <td><input id="surveryDateTime"></td>
                    <td>调查内容</td>
                    <td><input id="surveryContent"></td>
                </tr>                <tr>
                    <td>调查总体满意度</td>
                    <td><input id="overallSatisfaction"></td>
                    <td>备注</td>
