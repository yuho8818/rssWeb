...
<head>
    ...
    <script type="text/javascript" src="IC_js/SAFETRAIN_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿人员安全培训管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">受教育人</th>
                        <th class="table-title">一级教育状态</th>
                        <th class="table-title">一级教育人</th>
                        <th class="table-title">二级教育状态</th>
                        <th class="table-title">二级教育人</th>
                        <th class="table-title">三级教育状态</th>
                        <th class="table-title">三级教育人</th>
                        <th class="table-title">安环科确认</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr hidden="true">
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("SAFETRAIN_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("educatePeople")!=null ?entity.getAttributeValue("educatePeople"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("firstClassStatus")!=null ?entity.getAttributeValue("firstClassStatus"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("fisrtClassTeacher")!=null ?entity.getAttributeValue("fisrtClassTeacher"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("secondClassStatus")!=null ?entity.getAttributeValue("secondClassStatus"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("secondClassTeacher")!=null ?entity.getAttributeValue("secondClassTeacher"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("thirdClassStatus")!=null ?entity.getAttributeValue("thirdClassStatus"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("thirdClassTeacher")!=null ?entity.getAttributeValue("thirdClassTeacher"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("verify")!=null ?entity.getAttributeValue("verify"):""%>
                        </td>
                    </tr>
                    <%
                            }
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="SAFETRAIN_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    <td><input id="table_row_no"></td>                    <td>受教育人</td>
                    <td><input id="educatePeople"></td>
                </tr>                <tr>
                    <td>一级教育状态</td>
                    <td><input id="firstClassStatus"></td>
                    <td>一级教育人</td>
                    <td><input id="fisrtClassTeacher"></td>
                </tr>
                <tr>
                    <td>二级教育状态</td>
                    <td><input id="secondClassStatus"></td>
                    <td>二级教育人</td>
                    <td><input id="secondClassTeacher"></td>
                </tr>
                <tr>
                    <td>三级教育状态</td>
                    <td><input id="thirdClassStatus"></td>
                    <td>三级教育人</td>
                    <td><input id="thirdClassTeacher"></td>
                </tr>
                <tr>
                    <td>安环科确认</td>
                    <td><input id="verify"></td>
                </tr>            </table>
        </div>
