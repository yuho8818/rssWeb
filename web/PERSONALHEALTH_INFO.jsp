...
<head>
    ...
    <script type="text/javascript" src="IC_js/PERSONALHEALTH_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿人员健康管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">职工号</th>
                        <th class="table-title">体检日期</th>
                        <th class="table-title">体检机构</th>
                        <th class="table-title">是否复检</th>
                        <th class="table-title">结果概述</th>
                        <th class="table-title">禁忌病</th>
                        <th class="table-title">备注</th>
                        <th class="table-title">危害因素</th>
                        <th class="table-title">项目编号</th>
                        <th class="table-title">项目名称</th>
                        <th class="table-title">项目标准</th>
                        <th class="table-title">检查结果</th>
                        <th class="table-title">结果诊断</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr hidden="true">
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("PERSONALHEALTH_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("workerID")!=null ?entity.getAttributeValue("workerID"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("checkDate")!=null ?entity.getAttributeValue("checkDate"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("checkOrg")!=null ?entity.getAttributeValue("checkOrg"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("isReview")!=null ?entity.getAttributeValue("isReview"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("resultSummarize")!=null ?entity.getAttributeValue("resultSummarize"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("tabooDisease")!=null ?entity.getAttributeValue("tabooDisease"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("remarksText")!=null ?entity.getAttributeValue("remarksText"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("hazardFactors")!=null ?entity.getAttributeValue("hazardFactors"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("itemNo")!=null ?entity.getAttributeValue("itemNo"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("itemName")!=null ?entity.getAttributeValue("itemName"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("itemStandard")!=null ?entity.getAttributeValue("itemStandard"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("itemResult")!=null ?entity.getAttributeValue("itemResult"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("itemDiagnotics")!=null ?entity.getAttributeValue("itemDiagnotics"):""%>
                        </td>
                    </tr>
                    <%
                            }
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="PERSONALHEALTH_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    ...
                    <td>职工号</td>
                    <td><input id="workerID"></td>
                </tr>                <tr>
                    <td>体检日期</td>
                    <td><input id="checkDate"></td>
                    <td>体检机构</td>
                    <td><input id="checkOrg"></td>
                </tr>                <tr>
                    <td>是否复检</td>
                    <td><input id="isReview"></td>
                    <td>结果概述</td>
                    <td><input id="resultSummarize"></td>
                </tr>                <tr>
                    <td>禁忌病</td>
                    <td><input id="tabooDisease"></td>
                    <td>备注</td>
                    <td><input id="remarksText"></td>
                </tr>                <tr>
                    <td>危害因素</td>
                    <td><input id="hazardFactors"></td>
                    <td>项目编号</td>
                    <td><input id="itemNo"></td>
                </tr>                <tr>
                    <td>项目名称</td>
                    <td><input id="itemName"></td>
                    <td>项目标准</td>
                    <td><input id="itemStandard"></td>
                </tr>                <tr>
                    <td>检查结果</td>
                    <td><input id="itemResult"></td>
                    <td>结果诊断</td>
                    <td><input id="itemDiagnotics"></td>
                </tr>            </table>
        </div>
