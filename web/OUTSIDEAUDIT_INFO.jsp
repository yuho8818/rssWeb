...
<head>
    ...
    <script type="text/javascript" src="IC_js/OUTSIDEAUDIT_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿外审管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">检查内容</th>
                        <th class="table-title">条款</th>
                        <th class="table-title">审核要点</th>
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("OUTSIDEAUDIT_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("checkContent")!=null ?entity.getAttributeValue("checkContent"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("provision")!=null ?entity.getAttributeValue("provision"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("reviewPoint")!=null ?entity.getAttributeValue("reviewPoint"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("reviewMethod")!=null ?entity.getAttributeValue("reviewMethod"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("reviewRecord")!=null ?entity.getAttributeValue("reviewRecord"):""%>
                        </td>
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="OUTSIDEAUDIT_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    <td><input id="table_row_no"></td>                    <td>检查内容</td>
                    <td><input id="checkContent"></td>
                </tr>                <tr>
                    <td>条款</td>
                    <td><input id="provision"></td>
                    <td>审核要点</td>
                    <td><input id="reviewPoint"></td>
                </tr>
                <tr>
                    <td>审核方法</td>
                    <td><input id="reviewMethod"></td>
                    <td>审核记录</td>
                    <td><input id="reviewRecord"></td>
                </tr>
                <tr>
                    <td>备注</td>
