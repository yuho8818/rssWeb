...
<head>
    ...
    <script type="text/javascript" src="IC_js/INTERNALAUDIT_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿内审管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">受审核部门</th>
                        <th class="table-title">审核员</th>
                        <th class="table-title">时间</th>
                        <th class="table-title">标准条款</th>
                        <th class="table-title">审核内容</th>
                        <th class="table-title">审核方法</th>
                        <th class="table-title">审核记录</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr hidden="true">
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("INTERNALAUDIT_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("auditedDept")!=null ?entity.getAttributeValue("auditedDept"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("auditedPerson")!=null ?entity.getAttributeValue("auditedPerson"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("auditedDateTime")!=null ?entity.getAttributeValue("auditedDateTime"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("standardTerms")!=null ?entity.getAttributeValue("standardTerms"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("auditedContent")!=null ?entity.getAttributeValue("auditedContent"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("auditedMethod")!=null ?entity.getAttributeValue("auditedMethod"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("auditedRecord")!=null ?entity.getAttributeValue("auditedRecord"):""%>
                        </td>
                    </tr>
                    <%
                            }
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="INTERNALAUDIT_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    ...
                    <td>受审核部门</td>
                    <td><input id="auditedDept"></td>
                </tr>                <tr>
                    <td>审核员</td>
                    <td><input id="auditedPerson"></td>
                    <td>时间</td>
                    <td><input id="auditedDateTime"></td>
                </tr>                <tr>
                    <td>标准条款</td>
                    <td><input id="standardTerms"></td>
                    <td>审核内容</td>
                    <td><input id="auditedContent"></td>
                </tr>                <tr>
                    <td>审核方法</td>
                    <td><input id="auditedMethod"></td>
                    <td>审核记录</td>
                    <td><input id="auditedRecord"></td>
                </tr>            </table>
        </div>
