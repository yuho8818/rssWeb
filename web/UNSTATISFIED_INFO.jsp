...
<head>
    ...
    <script type="text/javascript" src="IC_js/UNSTATISFIED_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿不符合工作管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">检测时间</th>
                        <th class="table-title">事项描述</th>
                        <th class="table-title">检测人员</th>
                        <th class="table-title">责任人</th>
                        <th class="table-title">责任部门</th>
                        <th class="table-title">严重性等级</th>
                        <th class="table-title">拟采取措施</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr hidden="true">
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("UNSTATISFIED_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("checkDateTime")!=null ?entity.getAttributeValue("checkDateTime"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("itemDescription")!=null ?entity.getAttributeValue("itemDescription"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("checkPerson")!=null ?entity.getAttributeValue("checkPerson"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("responsibilityPerson")!=null ?entity.getAttributeValue("responsibilityPerson"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("responsibilityDept")!=null ?entity.getAttributeValue("responsibilityDept"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("accIDentSeverity")!=null ?entity.getAttributeValue("accIDentSeverity"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("proposedMeasures")!=null ?entity.getAttributeValue("proposedMeasures"):""%>
                        </td>
                    </tr>
                    <%
                            }
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="UNSTATISFIED_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    ...
                    <td>检测时间</td>
                    <td><input id="checkDateTime"></td>
                </tr>                <tr>
                    <td>事项描述</td>
                    <td><input id="itemDescription"></td>
                    <td>检测人员</td>
                    <td><input id="checkPerson"></td>
                </tr>                <tr>
                    <td>责任人</td>
                    <td><input id="responsibilityPerson"></td>
                    <td>责任部门</td>
                    <td><input id="responsibilityDept"></td>
                </tr>                <tr>
                    <td>严重性等级</td>
                    <td><input id="accIDentSeverity"></td>
                    <td>拟采取措施</td>
                    <td><input id="proposedMeasures"></td>
                </tr>            </table>
        </div>
