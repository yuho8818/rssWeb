...
<head>
    ...
    <script type="text/javascript" src="IC_js/MANAGEMENTREVIEW_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿评审管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">评审时间</th>
                        <th class="table-title">评审目的</th>
                        <th class="table-title">评审人员</th>
                        <th class="table-title">评审内容</th>
                        <th class="table-title">评审结论</th>
                        <th class="table-title">责任部门</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr hidden="true">
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("MANAGEMENTREVIEW_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("inspectionDateTime")!=null ?entity.getAttributeValue("inspectionDateTime"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("inspectionPurpose")!=null ?entity.getAttributeValue("inspectionPurpose"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("inspectionPeople")!=null ?entity.getAttributeValue("inspectionPeople"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("inspectionContent")!=null ?entity.getAttributeValue("inspectionContent"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("inspectionResult")!=null ?entity.getAttributeValue("inspectionResult"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("responsibilityDept")!=null ?entity.getAttributeValue("responsibilityDept"):""%>
                        </td>
                    </tr>
                    <%
                            }
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="MANAGEMENTREVIEW_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    <td><input id="table_row_no"></td>                    <td>评审时间</td>
                    <td><input id="inspectionDateTime"></td>
                </tr>                <tr>
                    <td>评审目的</td>
                    <td><input id="inspectionPurpose"></td>
                    <td>评审人员</td>
                    <td><input id="inspectionPeople"></td>
                </tr>
                <tr>
                    <td>评审内容</td>
                    <td><input id="inspectionContent"></td>
                    <td>评审结论</td>
                    <td><input id="inspectionResult"></td>
                </tr>
                <tr>
                    <td>责任部门</td>
                    <td><input id="responsibilityDept"></td>
                </tr>            </table>
        </div>
