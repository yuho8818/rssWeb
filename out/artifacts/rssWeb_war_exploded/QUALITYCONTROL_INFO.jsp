...
<head>
    ...
    <script type="text/javascript" src="IC_js/QUALITYCONTROL_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿质量控制计划管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">计划监控项目</th>
                        <th class="table-title">采用监控方法</th>
                        <th class="table-title">完成时限</th>
                        <th class="table-title">参加部门</th>
                        <th class="table-title">计划评估时间</th>
                        <th class="table-title">数量</th>
                        <th class="table-title">实施负责人</th>
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("QUALITYCONTROL_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("monotiorProject")!=null ?entity.getAttributeValue("monotiorProject"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("monotiorMethod")!=null ?entity.getAttributeValue("monotiorMethod"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("deadline")!=null ?entity.getAttributeValue("deadline"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("partDept")!=null ?entity.getAttributeValue("partDept"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("evaluateDateTime")!=null ?entity.getAttributeValue("evaluateDateTime"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("amount")!=null ?entity.getAttributeValue("amount"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("executiveDirector")!=null ?entity.getAttributeValue("executiveDirector"):""%>
                        </td>
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="QUALITYCONTROL_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    <td><input id="table_row_no"></td>                    <td>计划监控项目</td>
                    <td><input id="monotiorProject"></td>
                </tr>                <tr>
                    <td>采用监控方法</td>
                    <td><input id="monotiorMethod"></td>
                    <td>完成时限</td>
                    <td><input id="deadline"></td>
                </tr>
                <tr>
                    <td>参加部门</td>
                    <td><input id="partDept"></td>
                    <td>计划评估时间</td>
                    <td><input id="evaluateDateTime"></td>
                </tr>
                <tr>
                    <td>数量</td>
                    <td><input id="amount"></td>
                    <td>实施负责人</td>
                    <td><input id="executiveDirector"></td>
                </tr>
                <tr>
                    <td>备注</td>
