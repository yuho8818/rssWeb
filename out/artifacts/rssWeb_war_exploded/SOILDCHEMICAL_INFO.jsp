...
<head>
    ...
    <script type="text/javascript" src="IC_js/SOILDCHEMICAL_INFO.js"></script>
    ...
    <div class=" admin-content">
        ...
        <div class="admin-biaogelist">
            <div class="listbiaoti am-cf">
                <ul class="am-icon-flag on">﻿固化体管理</ul>
            ...
            <form class="am-form am-g">
                <table id="data_table" width="100%"
                    ...
                    <tr class="am-success">
                        ...
                        <th class="table-title">固化品名称</th>
                        <th class="table-title">固化类型</th>
                        <th class="table-title">用途</th>
                        <th class="table-title">最大储量</th>
                        <th class="table-title">存放地点</th>
                        <th class="table-title">实际储量</th>
                        <th class="table-title">备注</th>
                        <th class="table-title">统计日期</th>
                        <th class="table-title">统计人员</th>
                        <th class="table-title">审核人员</th>
                        <th class="table-title">审核日期</th>
                        <th class="table-title">处理批次</th>
                        <th class="table-title">分配去向</th>
                        <th class="table-title">分配人员</th>
                        <th class="table-title">分配日期</th>
                        <th class="table-title">处理单位</th>
                    </tr>
                    </thead>
                    <tbody>
                    <tr hidden="true">
                    ...
                    <tr>
                        ...
                        <td contenteditable="true" hidden="hidden"><%=entity.getAttributeValue("SOILDCHEMICAL_INFOUID") %>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("chemicalName")!=null ?entity.getAttributeValue("chemicalName"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("chemicalType")!=null ?entity.getAttributeValue("chemicalType"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("usage")!=null ?entity.getAttributeValue("usage"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("warehousing")!=null ?entity.getAttributeValue("warehousing"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("storagePlace")!=null ?entity.getAttributeValue("storagePlace"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("actualStorage")!=null ?entity.getAttributeValue("actualStorage"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("remarksText")!=null ?entity.getAttributeValue("remarksText"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("statisticalDate")!=null ?entity.getAttributeValue("statisticalDate"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("statisticalPerson")!=null ?entity.getAttributeValue("statisticalPerson"):""%>
                        </td>
                        ...
                        <td contenteditable="true"><%=entity.getAttributeValue("processBatches")!=null ?entity.getAttributeValue("processBatches"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("allotPalce")!=null ?entity.getAttributeValue("allotPalce"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("allotPerson")!=null ?entity.getAttributeValue("allotPerson"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("allotDate")!=null ?entity.getAttributeValue("allotDate"):""%>
                        </td>
                        <td contenteditable="true"><%=entity.getAttributeValue("processUnit")!=null ?entity.getAttributeValue("processUnit"):""%>
                        </td>
                    </tr>
                    <%
                            }
    ...
    <div class="am-modal-dialog">
        ...
        <div class="am-modal-bd">
            <table class="is-info-modify">
                <tr hidden="hidden">
                    <td>UID</td>
                    <td><input id="SOILDCHEMICAL_INFOUID"></td>
                    </td>
                </tr>
                <tr>
                    <td>编码</td>
                    <td><input id="table_row_no"></td>                    <td>固化品名称</td>
                    <td><input id="chemicalName"></td>
                </tr>                <tr>
                    <td>固化类型</td>
                    <td><input id="chemicalType"></td>
                    <td>用途</td>
                    <td><input id="usage"></td>
                </tr>
                <tr>
                    <td>最大储量</td>
                    <td><input id="warehousing"></td>
                    <td>存放地点</td>
                    <td><input id="storagePlace"></td>
                </tr>
                <tr>
                    <td>实际储量</td>
                    <td><input id="actualStorage"></td>
                    <td>备注</td>
                    <td><input id="remarksText"></td>
                </tr>
                <tr>
                    <td>统计日期</td>
                    <td><input id="statisticalDate"></td>
                    <td>统计人员</td>
                    <td><input id="statisticalPerson"></td>
                </tr>
                <tr>
                    <td>审核人员</td>
                ...
                <tr>
                    <td>处理批次</td>
                    <td><input id="processBatches"></td>
                    <td>分配去向</td>
                    <td><input id="allotPalce"></td>
                </tr>
                <tr>
                    <td>分配人员</td>
                    <td><input id="allotPerson"></td>
                    <td>分配日期</td>
                    <td><input id="allotDate"></td>
                </tr>
                <tr>
                    <td>处理单位</td>
                    <td><input id="processUnit"></td>
                </tr>            </table>
        </div>
